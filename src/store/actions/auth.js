...
export const auth = (email, password, isSignup) => {
    return dispatch => {
        ...
        let url = 'https://www.googleapis.com/identitytoolkit/v3/relyingparty/signupNewUser?key=AIzaSyC8pZdPk30hJoJYEFsEprO1t9CdGESuPAw';

        if (!isSignup) {
            url = 'https://www.googleapis.com/identitytoolkit/v3/relyingparty/verifyPassword?key=AIzaSyC8pZdPk30hJoJYEFsEprO1t9CdGESuPAw';
        }
